...
description: "CVPR 2026 — A novel approach to dataset distillation that builds datasets incrementally with complementary training signal."
image_small: /assets/img/lgd/banner.png
image_large: /assets/img/lgd/banner.png
image: assets/img/lgd/banner.png
# github: https://github.com/jachansantiago/mode_guidance
redirect: /learnability-guided-distillation/
importance: 1
horizontal: true
---
